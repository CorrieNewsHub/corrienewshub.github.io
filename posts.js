const posts = [
    {
        id: 1,
        title: "Nightmare Neighbours Shake Up Coronation Street",
        author: "Admin",
        ...
        content: `
            <h3>Nightmare Neighbours Shake Up Coronation Street</h3>
            <p>Residents of Weatherfield will need to watch their backs as Coronation Street welcomes the arrival of new &lsquo;nightmare neighbours&rsquo; this February.</p>
            ...
            <p>The Michaelis family will be moving into Mawdsley Street, at the back of Chesney and Gemma&rsquo;s house, marking the first time Coronation Street has extended the drama across the ginnel.</p>
            <p>Initially arriving on her own on the 12th February, Lou (<strong>Farrel Hegarty</strong>) immediately sparks up a friendship with Gemma (<strong>Dolly-Rose Campbell</strong>) as they recognise each other from Bessie Street School, where Gemma&rsquo;s quads and Lou&rsquo;s two young daughters attend.</p>
            <p>When Mick (<strong>Joe Layton</strong>) appears on 14th February, the audience will be shocked to realise his true identity&mdash;the man with the silver van who has been harassing Chesney (<strong>Sam Aston</strong>), who is none the wiser to who Mick really is.</p>
            <p>After developing a friendship with the Winter-Browns, it&rsquo;s evident that Mick and Lou are determined to create upheaval, starting with a prior connection to Kit Green (<strong>Jacob Roberts</strong>), leading to them exposing his secretive past.</p>
            
            <h4>Cast and Crew Speak</h4>
            
            <h4>Farrel Hegarty on Joining the Cast</h4>
            <p>"I&rsquo;m delighted and so grateful to be joining the cast of Coronation Street. I have genuinely been blown away by how ridiculously warm and nice everyone is."</p>
            <p>"Lou is definitely an exciting character to play because she&rsquo;s got good and bad parts to her, she&rsquo;s a life force and full of beans. She&rsquo;s a very colourful person who likes to make waves and try to cause chaos."</p>

            <h4>Joe Layton on Playing Mick</h4>
            <p>"Coronation Street is such an institute in British television and to get to walk down the cobbles in Mick&rsquo;s shoes is so exciting. To also do it alongside Farrel is awesome&mdash;we are having great fun together and connecting really well whilst developing our characters."</p>

            <h4>Producer Kate Brooks on the New Characters</h4>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="embed-responsive embed-responsive-16by9">
                <iframe src="//www.youtube.com/embed/hM9AM01qcoU?si=KLgjUJrxLk6_-VW1" width="560" height="314" allowfullscreen="allowfullscreen"></iframe>
            </div>
        `,
    ...
    {
        id: 3,
        title: "Explosive Drama Hits Coronation Street: The Platt Family Home in Flames",
        author: "Admin",
        image: "https://i2-prod.manchestereveningnews.co.uk/incoming/article30919261.ece/ALTERNATES/s810/1_JSR_MEN_260125_Corrie_08.jpg",
        content: `
            <h3>Explosive Drama Hits Coronation Street: The Platt Family Home in Flames</h3>
            <p>Coronation Street is bracing for more turmoil as the Platt family's beloved home is engulfed in flames, leaving fans to wonder who is responsible for the shocking blaze.</p>
            
            <p>David Platt's life has been spiraling out of control thanks to his dangerous entanglement with Harvey Gaskell's criminal gang. After taking stolen money tied to Harvey, David has become a target. Recent months have seen him and his family terrorized with threats, intimidation, and even a kidnapping attempt involving his wife, Shona.</p>

            <p>As if that wasn’t enough, viewers saw David confronted by the Radcliffe brothers—one of whom now sits behind bars for the murder of his own sibling. The family has also faced eerie warnings, including their dog being run over and a threatening note handed to Lily Platt.</p>

            <div class="post-image">
                <img src="https://i2-prod.manchestereveningnews.co.uk/incoming/article30919262.ece/ALTERNATES/s1200e/0_JSR_MEN_260125_Corrie_14JPG.jpg" class="img-fluid w-100" alt="Platt Family House Fire Scene">
            </div>

            <p>In an upcoming episode, airing from Monday, February 3, tensions reach a boiling point as a hooded figure is seen pushing a petrol-soaked rag through the letterbox of No. 8. The fire is soon confirmed to be arson, putting multiple residents under suspicion as they scramble to prove their innocence.</p>

            <h4>Who Could Be Behind the Fire?</h4>

            <p>According to spoilers, a group of children—Ruby Dobbs, Lily Platt, and Sam Blakeman—sneak into the Platt house to live stream a séance after becoming bored at Sarah Platt's birthday party. What starts as a spooky game turns deadly when a fire breaks out, and the question arises: who lit the match?</p>

            <h4>Abi Webster</h4>
            <p>Abi Webster may be a prime suspect. After seeing Toyah Habeeb interfere with her personal life by reporting her to social services, Abi heads to No. 8 in a rage. In a fit of PTSD-driven anger, she attacks Toyah and knocks her unconscious. Did Abi later return to the scene and start the fire to cover up what she had done?</p>

            <h4>Leanne Battersby</h4>
            <p>Another potential suspect is Leanne Battersby. Struggling with loneliness and anger, Leanne is seen wandering the cobbles in a drunken haze on the night of the fire. Could she be responsible for setting the devastating inferno?</p>

            <h4>David Platt</h4>
            <p>Of course, David himself might be a suspect. His feud with gang lord Harvey has escalated in recent weeks, and he has already suffered terrifying warnings from Harvey's men. Could David have staged the arson in a desperate attempt to claim insurance money and pay back the debt he owes?</p>
